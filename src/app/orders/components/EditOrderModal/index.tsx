...
import { OrderData, ConstructionCategory, IndividualWorkType, CollectiveWorkType, getWorkTypeOptions } from '../../types'
  ...
  const handleCategoryChange = (category: ConstructionCategory) => {
    setFormData(prev => ({
      ...
      workType: category === '個別'
        ? '個別' as IndividualWorkType
        : '集合' as CollectiveWorkType,
      // 個別に変更時は集合住宅情報をクリア
      ...(category === '個別' && {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="p-4 bg-gray-50 rounded-md border border-gray-200">
            ...
            <div className="mb-4">
              ...
              />
              <p className="text-xs text-gray-500 mt-1">※ 受注番号は編集できません</p>
            </div>

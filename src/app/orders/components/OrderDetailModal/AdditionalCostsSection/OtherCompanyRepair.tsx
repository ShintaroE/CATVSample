...
interface OtherCompanyRepairProps {
  data: AdditionalCosts['otherCompanyRepair']
  onChange: (data: AdditionalCosts['otherCompanyRepair']) => void
  isOpen: boolean
  onToggle: () => void
}

export default function OtherCompanyRepair({
  data,
  onChange,
  isOpen,
  onToggle,
}: OtherCompanyRepairProps) {
  ...
  return (
    <div className="bg-white p-3 rounded border">
      ...
      >
        <h5 className="text-sm font-medium text-gray-900">他社改修</h5>

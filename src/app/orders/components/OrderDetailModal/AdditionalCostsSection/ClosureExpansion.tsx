...
interface ClosureExpansionProps {
  data: AdditionalCosts['closureExpansion']
  onChange: (data: AdditionalCosts['closureExpansion']) => void
  isOpen: boolean
  onToggle: () => void
}

export default function ClosureExpansion({
  data,
  onChange,
  isOpen,
  onToggle,
}: ClosureExpansionProps) {
  ...
  return (
    <div className="bg-white p-3 rounded border">
      ...
      >
        <h5 className="text-sm font-medium text-gray-900">クロージャ増設</h5>

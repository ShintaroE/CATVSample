...
interface ConstructionFormProps {
    initialData?: Partial<ConstructionRequest>
    contractors: Contractor[]
    onSubmit: (data: Partial<ConstructionRequest>) => void
    onCancel: () => void
    isEditing?: boolean
}
...
export default function ConstructionForm({
    ...
    const defaultData: Partial<ConstructionRequest> = {
    ...
    const [formData, setFormData] = useState<Partial<ConstructionRequest>>({ ...defaultData, ...initialData })
    ...
    const handleChange = (field: string, value: string | boolean | PostConstructionApplicationReport) => {
        setFormData((prev) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const postReport = formData.postConstructionApplicationReport || { required: false }
        if (postReport.required && !postReport.status) {
